...
<div class="col-sm-7">
    ...
    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
        ...
        <appfuse:label styleClass="control-label" key="tradeProperty.agreementType"/>
        <form:select path="agreementType.id" items="${agreementTypeList}" cssClass="form-control" itemValue="id" itemLabel="name" />
        ...
        <form:select path="purchaserType.id" items="${purchaserTypeList}" cssClass="form-control" itemValue="id" itemLabel="name" />
...
$(document).ready(function() {
	...
	$('#manufactureDate-container').datepicker({format: "<fmt:message key='calendar.format'/>", weekStart: "<fmt:message key='calendar.weekstart'/>", language: '${pageContext.request.locale.language}'});
