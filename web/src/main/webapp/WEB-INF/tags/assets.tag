...
<c:choose>
    ...
    <c:when test="${sessionScope.debugAssets}">
        <link rel="stylesheet" type="text/css" href="${base}/webjars/bootswatch/3.3.1+2/spacelab/bootstrap.min.css"/>
        ...
        <script type="text/javascript" src="${base}/webjars/jquery-cookie/1.4.1-1/jquery.cookie.js"></script>
